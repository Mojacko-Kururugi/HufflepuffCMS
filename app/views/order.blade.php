...
<div class="row page-title">
  ...
  <div class="contents">
      <form action="{{ URL::to('/inventory/add-to-list') }}" method="POST" id="signup_validate" enctype="multipart/form-data"><br><br>
              <div class="row">
                          ...
                          <div class="card-content">
                                ...
                                <table class="table cart-table table-hover" v-show="!isCartEmpty">
                                    ...
                                    <tr>
                                      ...
                                      <td>{{$l->strItemDesc}}</td>
                                      <td>{{$l->intOQty}}</td>
                                      <td><a class="waves-effect waves-light btn btn-small red center-text" href="/inventory/rem-to-list/{{$l->intOProdID}}">REMOVE</a></td>
                                    </tr>
                                    @endforeach
                                    </tbody>
                                </table>
        ...
        <div class="row">
            ...
            <div class="row">
              <div class="input-field col l12 s12 center">
                <a class="waves-effect waves-light btn btn-green modal-btn" href="/inventory/add-order">SUBMIT</a>
