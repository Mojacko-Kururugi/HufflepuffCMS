                      ...
                      <tr>
                        ...
                        <td>
                            <div class="center-btn">
                             <a class="waves-effect waves-light btn green darken-1 btn-small center-text" href="emp/{{$data->strUCode}}">UPDATE</a>
                             <a class="waves-effect waves-light btn red lighten-1 btn-small center-text" href="delete-emp/{{$data->strUCode}}">DELETE</a>
                            </div>
                        </td>
                    </tr>
                   @endforeach 
