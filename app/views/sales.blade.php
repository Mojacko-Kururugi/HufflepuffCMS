  ...
  <div class="container-fluid">
    <div class="row">
        <div class="col s12 m12 l12">
            ...
            <a class="modal-trigger waves-effect waves-light btn blue darken-1 btn-small center-text" href="/add-payment">ADD NEW PAYMENT</a>
      			<a class="modal-trigger waves-effect waves-light right btn btn-small btn-flat center-text" href="{{ URL::to('/reports') }}">GENERATE SALES REPORT</a>
        </div>
     </div>
