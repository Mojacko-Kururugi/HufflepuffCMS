...
<div class="main-wrapper">
  ...
  <form action="{{ URL::to('/doc-joborder-add') }}" method="POST" id="signup_validate" enctype="multipart/form-data">
       <div class="row">
       @if($data3 != null)
      ...
      @endif
            <div class="input-field col s12 m4 l4">
              <!-- dapat autogenerated-->
              <input type="text" name="transaction-no" required="" value="{{Session::get('doc-sess')}}">
