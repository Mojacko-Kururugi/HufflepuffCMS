...
<body>
  <nav class="blue" role="navigation">
    <div class="nav-wrapper container">
      <a id="logo-container" href="#" class="brand-logo">WELCOME!</a>
  ...
  <div class="nav-wrapper">
    <div id="index-banner" class="parallax-container">
      <div class="section no-pad-bot">
        <div class="container">
          <br><br>
          <h1 class="header center teal-text text-lighten-2">Connie's Optical Clinic</h1>
          <div class="row center">
            <h5 class="header col s12 light">Bright Vision. Bright Future.</h5>
          </div>
          <div class="row center">
            <a href="/logout" class="btn-large waves-effect waves-light teal lighten-1">Log In</a>
          </div>
          <br><br>

        </div>
      </div>
      <div class="parallax"><img src="img/bg2.jpg" alt="Unsplashed background img 1" width="500" /></div>
    </div>
